  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-nexus-dark-slate p-6">
      ...
      <div className="max-w-md w-full bg-nexus-blue/20 backdrop-blur-xl border border-nexus-slate/30 p-8 rounded-3xl shadow-2xl relative z-10">
        <h2 className="text-3xl font-bold text-center text-nexus-porcelain mb-2">Create an Account</h2>
        <p className="text-center text-nexus-slate mb-8">Start organizing your teaching toolkit.</p>
        
        <form onSubmit={handleSignup} className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-nexus-slate mb-1">Full Name</label>
            <input 
              type="text" 
              required
          ...
          <div>
            <label className="block text-sm font-medium text-nexus-slate mb-1">Password</label>
            <input 
              type="password" 
              required
              placeholder="••••••••"
        ...
        <p className="mt-6 text-center text-sm text-nexus-slate">
          ...
          <Link to="/login" className="font-medium text-nexus-bronze hover:text-white transition-colors">
            Sign in
          </Link>
        </p>
      </div>
