  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-partner-dark-slate p-6">
      ...
      <div className="max-w-md w-full bg-partner-blue/20 backdrop-blur-xl border border-partner-slate/30 p-8 rounded-3xl shadow-2xl relative z-10">
        <h2 className="text-3xl font-bold text-center text-partner-porcelain mb-2">Welcome Back</h2>
        <p className="text-center text-partner-slate mb-8">Enter your credentials to access your portal</p>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              <label className="block text-sm font-medium text-partner-slate">Password</label>
              <a href="#" className="text-xs text-partner-bronze hover:text-white transition-colors">Forgot password?</a>
            </div>
            <input 
              type="password" 
              required
        ...
        <p className="mt-6 text-center text-sm text-partner-slate">
          New to Partner?{' '}
          <Link to="/signup" className="font-medium text-partner-bronze hover:text-white transition-colors">
            Create an account
          </Link>
        </p>
      </div>
